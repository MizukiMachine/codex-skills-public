---
name: gcommit
description: "Git作業ツリーを確認し、新しいブランチを作成して安全にコミットする。gc、$gc、コミット、git commit、ブランチ作成とコミット、コミットして、変更をコミット、ブランチ切ってコミットなどを求められたときに使う。変更ファイルが多い場合は意味のある単位に分けてコミットする。"
---
