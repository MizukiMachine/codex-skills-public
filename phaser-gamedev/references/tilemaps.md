...
Comprehensive expert guide for Phaser tilemap integration with Tiled Map Editor.

## Contents

- [Tiled Map Editor Fundamentals](#tiled-map-editor-fundamentals)
- [Tiled JSON Format Structure](#tiled-json-format-structure)
- [Global Tile IDs (GIDs)](#global-tile-ids-gids)
- [Loading Tilemaps in Phaser](#loading-tilemaps-in-phaser)
...
- [Camera and World Bounds](#camera-and-world-bounds)
- [Parallax Scrolling](#parallax-scrolling)
- [Animated Tiles](#animated-tiles)
- [Procedural Tilemaps](#procedural-tilemaps)
- [Debugging Tilemaps](#debugging-tilemaps)
- [Terrain Auto-Tiling (Tiled Feature)](#terrain-auto-tiling-tiled-feature)
- [Performance Tips](#performance-tips)
- [Quick Reference](#quick-reference)

## Version And Asset Contract

- Verify Phaser major version before using renderer-specific tilemap features.
- Keep Tiled JSON, external tilesets, and image paths together so loader paths resolve from the deployed asset root.
- Prefer property-driven collision (`collides: true`, `oneWay: true`, `type: lava`) over hard-coded tile indexes when maps are edited by hand.
- In Phaser 4, explicitly verify camera rounding and any GPU tilemap layer choices in browser before assuming Phaser 3 visual behavior carries over.
