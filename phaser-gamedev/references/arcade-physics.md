...
Comprehensive reference for the Phaser Arcade Physics system.

## Contents

- [World Configuration](#world-configuration)
- [Body Types](#body-types)
- [Body Sizing and Shape](#body-sizing-and-shape)
- [Collision Detection](#collision-detection)
- [Collision Categories](#collision-categories)
- [Groups](#groups)
- [Object Pooling](#object-pooling)
- [Movement Patterns](#movement-patterns)
- [Velocity Helpers](#velocity-helpers)
...
Use Arcade collision categories when groups should collide with only specific other groups. These helpers exist in Phaser 3.70+ and Phaser 4; guard the version before adding them to older Phaser 3 projects.
...
player.setCollidesWith([ENEMY, PICKUP]);

enemies.setCollisionCategory(ENEMY);
enemies.setCollidesWith([PLAYER]);
```

Keep categories named constants. Avoid scattering raw bitmasks through scene code.
