...
Keep `.glb`, textures, and JSON under `public/assets/` so Vite copies them verbatim into `dist/` and Capacitor ships them as bundled native assets (Android APK/AAB assets, iOS app bundle).
